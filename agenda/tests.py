            ...
            [
                {
                    ...
                    "data_horario": "2020-04-04T00:00:00Z",
                    "email_cliente": "",
                    "telefone_cliente": "",
                },
                {
                    "id": 2,
                    "nome_cliente": "testeiro2",
                    "data_horario": "2020-05-05T00:00:00Z",
                    "email_cliente": "",
                    "telefone_cliente": "",
                },
            ],
...
class TestCriacaoAgendamento(APITestCase):
    def test_cria_agendamento(self):
        ...
        self.assertEqual(
            ...
            datetime(2020, 12, 6, 15, 0, tzinfo=timezone.utc),
        )
        ...
        resposta_get = [
            b'[{"id": 1, "data_horario": "2020-12-06T15:00:00Z", "nome_cliente": "testeiro1", "email_cliente": "teste@email.com", "telefone_cliente": "2345678777"}]'
        ]
...
class TestPatch(APITestCase):
    def test_patch(self):
        ...
        response_patch = self.client.patch(
            f"/api/agendamentos/{agendamento_criado.id}/", patch_request, format="json"
        )
